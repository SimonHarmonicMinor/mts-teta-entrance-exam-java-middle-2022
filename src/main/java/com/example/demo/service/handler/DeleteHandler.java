...
public class DeleteHandler implements Handler {
    ...
    public DeleteHandler(UserRepository userRepository, TasksRepository tasksRepository, Validator validator) {
    ...
    public Request.Command getCommand() {
        return Request.Command.DELETE_TASK;
    }
    ...
    private Response run(String userName, String taskName) {
        ...
        return new Response(Response.Result.DELETED, true);
    }
}
