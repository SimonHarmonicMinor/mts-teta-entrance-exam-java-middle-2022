...
public class CloseHandler implements Handler {
    ...
    public CloseHandler(UserRepository userRepository, TasksRepository tasksRepository, Validator validator) {
    ...
    public Request.Command getCommand() {
        return Request.Command.CLOSE_TASK;
    }
    ...
    private Response validate(String userName, String taskName) {
        ...
        if(!validator.validateTaskStateMatch(task, Task.State.CREATED)) {
    ...
    private Response run(String userName, String taskName) {
        ...
        return new Response(Response.Result.CLOSED, true);
    }
}
