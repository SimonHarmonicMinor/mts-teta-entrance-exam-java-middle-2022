...
import com.example.demo.service.impl.CommandParserImpl;
...
public class Server {
  ...
  private final CommandRequestHandler handler = new CommandRequestHandlerImpl();
      ...
      while (true) {
        try {
          ...
          try (
            ...
            try {
              result = executor.execute(handler.handle(parser.parseFromString(line)));
